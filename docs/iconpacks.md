...
Issuer field in Tesser is matched against for automatic selection of an icon for
...
icon pack into Tesser.

### Using icon packs in Tesser

Users can download an icon pack from the internet and import it into Tesser
through the settings menu. Tesser extracts the icon pack to
...
After that, Tesser will start proposing icons for new entries if the issuer
